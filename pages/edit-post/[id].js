...
const projectSecret = process.env.NEXT_PUBLIC_IPFS_INFURA_SECRET_ID;
const auth =
...
export default function Post() {
  ...
  async function fetchPost() {
    ...
    if (process.env.NEXT_PUBLIC_ENVIRONMENT === "local") {
      ...
      provider = new ethers.providers.JsonRpcProvider(`https://rinkeby.infura.io/v3/${process.env.NEXT_PUBLIC_INFURA_ID}`);
